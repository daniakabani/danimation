...
const CALENDLY_LINK = 'https://calendly.com/daniakabani/30-mins-meeting-with-dani'
      ...
      <div className='relative z-10 container mx-auto px-4'>
        <div className='flex max-w-4xl flex-col gap-8'>
          ...
          <div className='space-y-4'>
            ...
            >
              I’m Dani Akabani. A Staff Frontend Engineer obsessed with performance, design systems,
              and building applications that feel
